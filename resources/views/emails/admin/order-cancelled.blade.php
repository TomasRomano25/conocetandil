...
<head>
  ...
  <title>Pedido cancelado — Conoce Tandil</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#2D6A4F 0%,#52B788 100%);padding:32px 40px;text-align:center;">
              ...
              <h1 style="margin:0;color:#ffffff;font-size:24px;font-weight:700;line-height:1.3;">Pedido cancelado</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:40px;">
              <p style="margin:0 0 24px 0;font-size:15px;color:#444;line-height:1.6;">
                @if($type === 'hotel')
                  Un pedido de hotel fue cancelado.
                @else
                  Un pedido de membresía fue cancelado.
                @endif
              </p>

              <!-- Status badge -->
              <div style="text-align:center;margin:0 0 20px 0;">
                <span style="display:inline-block;background:#FEE2E2;color:#991B1B;font-size:12px;font-weight:700;letter-spacing:1px;text-transform:uppercase;padding:6px 16px;border-radius:20px;border:1px solid #FECACA;">CANCELADO</span>
              </div>
